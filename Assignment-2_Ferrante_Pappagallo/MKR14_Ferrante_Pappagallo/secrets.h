...
#define MQTT_CLIENTID "marco_pappagallo3"                 // client identifier
#define MQTT_USERNAME "MarcoPappagallo"            // mqtt user's name
#define MQTT_PASSWORD "iot847963"            // mqtt user's password
...
#define MYSQL_USER "MarcoPappagallo"                  // db user
#define MYSQL_PASS "iot847963"     //         // db user's password
